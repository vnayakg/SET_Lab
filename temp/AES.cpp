...
// The number of columns comprising a state in AES or we can say matrix size when we arrange plain text in 
// matrix format
#define Nb 4

// The number of rounds in, it is initialized to zero. value depends upon the given key
int Nr=0;
